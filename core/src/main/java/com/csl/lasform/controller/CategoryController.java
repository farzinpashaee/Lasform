...
public class CategoryController extends AbstractCrudController<Category> {
    ...
    /** Paginated/sortable listing for the management table, optionally filtered by free-text {@code q} (name/description). */
    @GetMapping("/search")
    public Page<Category> search(@RequestParam(required = false) String q, Pageable pageable) {
