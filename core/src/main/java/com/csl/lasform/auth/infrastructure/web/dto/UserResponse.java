...
public record UserResponse(String id, String orgId, String email, UserStatus status, boolean mustResetPassword, Instant createdAt) {

    public static UserResponse from(User user) {
        return new UserResponse(
                user.getId(), user.getOrgId(), user.getEmail(), user.getStatus(), user.isMustResetPassword(), user.getCreatedAt());
    }
}
